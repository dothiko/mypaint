...
class StampEditorWindow (SubWindow):
    ...
    def __init__(self, app, stamp_manager):
        self.manager = stamp_manager
        self._stamp = self.manager.current
       #app = None
       #if __name__ != '__main__':
       #    from application import get_app
       #    app = get_app()
       #    self._stamp = app.stamp
       #    sm = app.stampmanager
    ...
    def save_button_clicked_cb(self, button):
        """Save the current stamp settings (overwrites)"""
